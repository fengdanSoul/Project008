...
<script>
  ...
  import { shopOrderList, shopOrderPay, shopPayType, shopPayNumber, shopOrderDelivery, shopOrderFlag } from '@/api/shopOrder' //, shopOrderDelivery, shopOrderFlag, shopOrderDetails,
  export default {
    data() {
      return {
        dialogVisible: false,
